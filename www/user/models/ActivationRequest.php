<?php
	...
	/**
	 * The ActivationRequest is an active record and model representing a single
	 * Activation Request record.
	 *
	 * @author Matthew J. Sahagian [mjs] <gent@dotink.org>
	 * @copyright Copyright (c) 2011, Matthew J. Sahagian
	 */
	class ActivationRequest extends ActiveRecord
	{

		/**
		 * Initializes all static class information for the ActivationRequest model
		 *
		 * @static
		 * @access public
		...
		/**
		 * Gets the record name for the ActivationRequest class
		 *
		 * @static
		 * @access public
		 * @param void
		...
		/**
		 * Gets the record table name for the ActivationRequest class
		 *
		 * @static
		 * @access public
		 * @param void
		...
		/**
		 * Gets the record set name for the ActivationRequest class
		 *
		 * @static
		 * @access public
		 * @param void
		...
		/**
		 * Gets the entry name for the ActivationRequest class
		 *
		 * @static
		 * @access public
		 * @param void
		...
		/**
		 * Gets the order for the ActivationRequest class
		 *
		 * @static
		 * @access public
		 * @param void
		...
		/**
		 * Creates a new ActivationRequest from a slug and identifier.  The
		...
		/**
		 * Creates a new ActivationRequest from a provided resource key.
		 *
		 * @static
		 * @access public
