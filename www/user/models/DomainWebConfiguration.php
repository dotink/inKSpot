<?php
	...
	/**
	 * The DomainWebConfiguration is an active record and model representing a single
	 * Domain Web Configuration record.
	 *
	 * @author Matthew J. Sahagian [mjs] <gent@dotink.org>
	 * @copyright Copyright (c) 2011, Matthew J. Sahagian
	 */
	class DomainWebConfiguration extends ActiveRecord
	{

		/**
		 * Initializes all static class information for the DomainWebConfiguration model
		 *
		 * @static
		 * @access public
		...
		/**
		 * Gets the record name for the DomainWebConfiguration class
		 *
		 * @static
		 * @access public
		 * @param void
		...
		/**
		 * Gets the record table name for the DomainWebConfiguration class
		 *
		 * @static
		 * @access public
		 * @param void
		...
		/**
		 * Gets the record set name for the DomainWebConfiguration class
		 *
		 * @static
		 * @access public
		 * @param void
		...
		/**
		 * Gets the entry name for the DomainWebConfiguration class
		 *
		 * @static
		 * @access public
		 * @param void
		...
		/**
		 * Gets the order for the DomainWebConfiguration class
		 *
		 * @static
		 * @access public
		 * @param void
		...
		/**
		 * Creates a new DomainWebConfiguration from a slug and identifier.  The
		...
		/**
		 * Creates a new DomainWebConfiguration from a provided resource key.
		 *
		 * @static
		 * @access public
