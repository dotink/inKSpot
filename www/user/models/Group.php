<?php
	...
	/**
	 * The Group is an active record and model representing a single
	 * Group record.
	 *
	...
	class Group extends ActiveRecord
	{
		...
		/**
		 * Initializes all static class information for the Group model
		 *
		 * @static
		 * @access public
		...
		/**
		 * Gets the record name for the Group class
		 *
		 * @static
		 * @access public
		 * @param void
		...
		/**
		 * Gets the record table name for the Group class
		 *
		 * @static
		 * @access public
		 * @param void
		...
		/**
		 * Gets the record set name for the Group class
		 *
		 * @static
		 * @access public
		 * @param void
		...
		/**
		 * Gets the entry name for the Group class
		 *
		 * @static
		 * @access public
		 * @param void
		...
		/**
		 * Gets the order for the Group class
		 *
		 * @static
		 * @access public
		 * @param void
		...
		/**
		 * Creates a new Group from a slug and identifier.  The
		...
		/**
		 * Creates a new Group from a provided resource key.
		 *
		 * @static
		 * @access public
